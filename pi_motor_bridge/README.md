...
| Wheel buzzes but doesn't rotate              | PWM duty too low to overcome static friction (≤15% on JYQDs is unreliable), or direction reversed without a STOP between. Bump to ≥25% and pause briefly between reversals |
